...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['about'])) {
        ...
        $sql2 = "UPDATE termcondition SET  about=\"$about\" where sno=1 ";
...
$sql1 = "SELECT * from termcondition ";
...
if (isset($_SESSION['username'])) {
  ...
  <strong>Content information changed successful!</strong> 
                            ...
                            <div id="content" class="main-content">
                                <div class="layout-px-spacing">
                                    <div style='display:flex; justify-content: space-between'>
                                        <h5 class="mb-4">Terms & Coditions Contents</h5>
                                        <a class="btn btn-primary" style='height:35px;' href='addcondition.php'>
                                            Change Content
                                        </a>
                                    </div>
