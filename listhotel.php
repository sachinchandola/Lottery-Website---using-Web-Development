        ...
        <div class="content">
            ...
            if (isset($_GET['alertdelete'])) {
                ...
                <div class='alert alert-success alert-dismissible fade show' role='alert' id='tutorial'>
                    <strong>Hotels information deleted successful!</strong>
            ...
            if ($alertupdate == 'true') {
                ...
                <div class='alert alert-success alert-dismissible fade show' role='alert' id='tutorial'>
                    <strong>Hotels information updated successful!</strong>
                    <a href='#' class='close' data-dismiss='alert' aria-label='close' onclick='myRemoveFunction()'>&times;</a>
                    </button>
                </div>
                <?php
            ...
            if ($alerthotels == 'true') {
                ?>
                <div class='alert alert-success alert-dismissible fade show' role='alert' id='tutorial'>
                    <strong>Hotels information added successful!</strong>
                    <a href='#' class='close' data-dismiss='alert' aria-label='close' onclick='myRemoveFunction()'>&times;</a>
                    </button>
                </div>
                <?php
                            ...
                            <div id="content" class="main-content">
                                <div class="layout-px-spacing">
                                    <div style='display:flex; justify-content: space-between'>
                                        <h5 class="mb-4">Hotels List</h5>
                                        <a class="btn btn-primary" style='height:35px;' href='edithotel.php'>
                                            Add New Hotel</a>
                                    </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div style='display:flex;'>
                                                                            ...
                                                                            <a href='edithotel.php?type=edit&uid=<?php echo $data['sno'] ?>'
                                                                        ...
                                                                        <div class="modal-content p-4">
                                                                            ...
                                                                            <div class="modal-footer border-0">
                                                                                ...
                                                                                <a class="btn btn-primary"
                                                                                    href='edithotel.php?type=delete&uid=<?php echo $data['sno'] ?>'>Yes,
                                                                                    Delete !!</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
