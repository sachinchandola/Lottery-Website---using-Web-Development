...
//changing images
if (isset($_FILES['favi'])) {
    
    $namee = $_FILES['favi']['name'];
    $temp = $_FILES['favi']['tmp_name'];

    move_uploaded_file($temp, './img/' . $namee);

    $image = $namee;

    $sql2 = "UPDATE logofavi SET favi='$image' where sno=1 ";
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <?php include 'includes/settingnav.php';?>    
                                ...
                                <div class='contentt'>
                                    <br>
                                    <form action="favicon.php" method='post' enctype="multipart/form-data">
                                        <div class="row mb-3">
                                            <label for="formFile" class="form-label"
                                                style=" margin-top: 5px; margin-left: 20px;"> Add Favicon</label>

                                            <input class="form-control bg-dark" name='favi' accept='.jpg, .jpeg, .png'
                                        ...
                                        <div id='inputs1' style=" width:1000px; margin-top:20px; margin-left: 20px;">
                                            <p style='margin-left:20px;'>Previous Favicon</p>
                                            <div id='images'> <img src="./img/<?php echo $temp['favi']; ?>" alt=""></div>
                                        </div>
                                        <br>
