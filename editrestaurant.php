...
if (isset($_GET['uid'])) {
    $id = $_GET['uid'];
    if ($_GET['type'] == 'edit') {
        $getdata = mysqli_query($con, "SELECT * FROM `restaurants` WHERE `sno`=$id");
        ...
        if (isset($_POST['add'])) {
            ...
            $sql = "UPDATE restaurants SET `name`='$name', `description`='$description', `state`='$state', `district`='$district', `phoneNo`='$phoneNo', `email`='$email', `gmap`='$gmap', `whatsapp`='$whatsapp', `offer`='$offer'  WHERE `sno`=$id";
        ...
        mysqli_query($con, "DELETE FROM `restaurants`  WHERE sno =$id");
    ...
    if (isset($_POST['add'])) {
        ...
        $gmap = $_POST['gmap'];
        // insert pages
        $page_sql = "INSERT INTO restaurants (`name`, `description`, `state`, `district`, `offer`, `whatsapp`, `phoneNo`, `email`, `gmap` )
        ...
        if ($con->query($page_sql) === TRUE) {
            ...
            echo "<script>window.location.href='listhomestay'</script>";
            exit();
        } else {
...
if(isset($_POST['img_delete'])){
    ...
    $img_id = $_POST['img_id'];
    // delete image
    mysqli_query($con, "DELETE FROM `imagerestaurant`  WHERE `sno` =$img_id");
    echo "<script>window.location.href='editrestaurant?type=edit&uid=' + hotel_id</script>";
}
?>
                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-secondary rounded h-100 p-4">
                        <div style='display:flex; justify-content: space-between'>
                            ...
                            <a class="btn btn-primary" style='height:35px;' href='listhomestay'>Restaurant List</a>
                        </div>
