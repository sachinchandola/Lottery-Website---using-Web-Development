...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['about'])) {
        ...
        $sql2 = "UPDATE privacy SET  about=\"$about\" where sno=1 ";
                            ...
                            <div id="content" class="main-content">
                                <div class="layout-px-spacing">
                                    <div style='display:flex; justify-content: space-between'>
                                        <h5 class="mb-4">Privacy Policy Contents</h5>
                                        <a class="btn btn-primary" style='height:35px;' href='addprivacy.php'>
                                            Change Content
                                        </a>
                                    </div>
